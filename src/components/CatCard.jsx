...
function CatCard({ cat }) {
  return (
    <div className="card bg-white rounded-3xl min-w-[30%] max-h-[80vh] overflow-hidden mx-3">
      <div className="image w-full h-1/2 bg-blue-500">
        <img className="w-full h-full object-cover" src={cat.image} alt="" />
      </div>
      <div className="p-3 w-full h-1/2 space-y-2">
        ...
        <span className="origin font-semibold text-[14px]">
          Origin
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </span>
        <span className="text-[14px]">{cat.origin}</span>
        <div className="tags lifeSpan font-semibold text-[14px]">
          Temprament:
